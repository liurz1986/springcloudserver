package com.kedacom.order.common;
...
public class HttpHelper {
	...
	public static void main(String[] args) {
		String url = "http://localhost:8771/users/test?token=fafafdato";
		JSONObject jsonparams = new JSONObject();
		jsonparams.put("id", 123456);
		jsonparams.put("name", "liurz");
		jsonparams.put("age", 123);
		jsonparams.put("pwd", "liurz1986");
		...
		String res = HttpHelper.sendPost(url, jsonparams.toString());
